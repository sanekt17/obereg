# Deploying the landing page — sanekt17.github.io/obereg

(Maintainer notes. The public description of the app is in README.md.)
...
## Two things to fill in later (edit index.html, search for "CONFIG")
...
Per-channel tracking (docs/32 §D): on launch day give each channel its own Play link with a `referrer=` UTM.
